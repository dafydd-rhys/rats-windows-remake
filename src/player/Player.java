...
public class Player {
     ...
     *
     */
    private static final String players = System.getProperty("user.dir") +
            "\\src\\resources\\players\\players.txt";
    /**
     *
     */
     ...
     */
    public Player(String playerName, THEME theme, ItemGeneration generation)
            throws IOException {
