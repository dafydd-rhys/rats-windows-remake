...
public class InventoryInteraction {
    ...
    private static final String dir = System.getProperty("user.dir") + "/src/resources/images/game/entities/";
    private static final Image bombImage = new Image(dir + "bomb.png");
