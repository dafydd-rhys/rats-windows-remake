...
public class NoEntrySign extends Item {
    ...
    public NoEntrySign() {
        ...
        setImage(new Image(System.getProperty("user.dir") +
                "/src/resources/images/game/entities/no-entry-sign-5.png"));
        setHp(10);
        setDamage(0);
        setRange(1);
    ...
    public void playSound()
        ...
        playGameEffect(System.getProperty("user.dir") +
                "/src/resources/audio/game/oof.wav");
    }
    ...
    public void activate(Level level, GraphicsContext gc) {
        switch (getHp()) {
            case 8 -> setImage(new Image(System.getProperty("user.dir") +
                    "/src/resources/images/game/entities/no-entry-sign-4.png"));
            case 6 -> setImage(new Image(System.getProperty("user.dir") +
                    "/src/resources/images/game/entities/no-entry-sign-3.png"));
            case 4 -> setImage(new Image(System.getProperty("user.dir") +
                    "/src/resources/images/game/entities/no-entry-sign-2.png"));
            case 2 -> setImage(new Image(System.getProperty("user.dir") +
                    "/src/resources/images/game/entities/no-entry-sign-1.png"));
            case 0 -> {
