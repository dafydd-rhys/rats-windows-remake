...
public class StageResizer {
     ...
     * @param listener
     */
    private static void addListenerDeeply(Node node,
                    ...
                    if (!Cursor.W_RESIZE.equals(cursorEvent) &&
                        ...
                        if (Cursor.NW_RESIZE.equals(cursorEvent) ||
                            ...
                            double newHeight = stage.getHeight() -
                                    (mouseEvent.getScreenY() - stage.getY());
                            ...
                            if (newHeight >= minHeight &&
                                ...
                                newHeight =
                                        Math.min(Math.max(newHeight, minHeight),
                                                maxHeight);
                                stage.setY(stage.getY() + stage.getHeight() -
                                        newHeight);
                                stage.setHeight(newHeight);
                            }
                        } else {
                            stage.setHeight(Math.min(
                                    Math.max(mouseEventY + startY, minHeight),
                                    maxHeight));
                        }
                    }
                    ...
                    if (!Cursor.N_RESIZE.equals(cursorEvent) &&
                        ...
                        if (Cursor.NW_RESIZE.equals(cursorEvent) ||
                            ...
                            double newWidth = stage.getWidth() -
                                    (mouseEvent.getScreenX() - stage.getX());
                            ...
                            if (newWidth >= minWidth && newWidth <= maxWidth) {
                                ...
                                newWidth =
                                        Math.min(Math.max(newWidth, minWidth),
                                                maxWidth);
                            ...
                            stage.setWidth(Math.min(
                                    Math.max(mouseEventX + startX, minWidth),
                                    maxWidth));
                        }
                    }
                }
